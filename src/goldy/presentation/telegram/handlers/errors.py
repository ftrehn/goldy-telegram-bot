...
ERROR_TEXTS: Final[Mapping[type[AppError], str]] = {
    ...
    # The site (ADR-0004).
    SiteUnavailableError: text_keys.SITE_UNAVAILABLE,
    SiteAccountNotLinkedError: text_keys.SITE_NOT_LINKED,
    SiteLinkCodeInvalidError: text_keys.SITE_LINK_CODE_INVALID,
    SiteLinkForbiddenError: text_keys.SITE_LINK_FORBIDDEN,
    SiteCustomerNotLinkedError: text_keys.SITE_CUSTOMER_NOT_LINKED,
    SiteFinanceDeniedError: text_keys.SITE_FINANCE_DENIED,
    SiteOrderRejectedError: text_keys.SITE_ORDER_REJECTED,
    SiteOrderNotCancellableError: text_keys.SITE_ORDER_NOT_CANCELLABLE,
