...
# Ссылки с сайта. Без плейсхолдеров: товар либо снят, либо его никогда не было,
# назвать его нечем, а сообщение с аргументом, который нечем заполнить, Fluent
# не отрисует вовсе.
deeplink-product-gone = Ссылка ведёт на товар, которого больше нет в каталоге. Открываем каталог — посмотрите похожие.
deeplink-category-gone = Раздела из ссылки больше нет в каталоге. Открываем каталог с первого экрана.
