...
checkout-address-prompt = Куда доставить? Отправьте адрес одной строкой: город, улицу, дом и квартиру. Доставка только по России, адрес — кириллицей и с номером дома.
...
checkout-comment-prompt = Комментарий к заказу — например, удобное время доставки, до { $max_length } символов. Или пропустите шаг.
