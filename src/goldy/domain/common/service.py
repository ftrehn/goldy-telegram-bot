class BaseDomainService:
    ...
    Domain services must be stateless — all required data comes from method
    parameters or injected domain ports (Protocols). Anything an aggregate can
    decide by looking at its own fields belongs on the aggregate instead.
    """
